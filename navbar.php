    ...
    <nav class="navbar navbar-expand-lg navbar-light " style=" background-color: #fdff7e00;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link " href="../Auth/home.html">Home
                    <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link" href="../body_check/bodycheck.php">Body Check
                    <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link active" href="workout.php">Workout
                    <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link " href=" ../Auth/about2.html">About
                    <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link" href="
				article2.html">Article <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link " href="../Auth/profile.php">| Profile |
                    <span class="sr-only">(current)</span></a>
